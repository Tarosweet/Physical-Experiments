...
public class InfinityTransferActionBuilder : IFluidActionBuilder
{
    private FluidContainer _containerFrom;
    private FluidContainer _containerTo;
    private float _count;
    
    public InfinityTransferActionBuilder(FluidContainer containerFrom, FluidContainer containerTo, float count)
    {
